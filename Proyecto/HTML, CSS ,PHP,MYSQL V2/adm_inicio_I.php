...
<body>
    ...
    <main class="d-flex flex-nowrap align-items-center">
        <section class="container-fluid">
            <article class="con_inicio row align-items-md-stretch justify-content-center h-75">
                <div class="con_inicio1 col-md-4">
                </div>
